      ...
      <section className="trust section" id="trust">
        <div className="shell trust-grid">
          ...
          <div className="trust-copy reveal" data-reveal>
            ...
            <h2>Опыт, которому<br />можно доверять</h2>
            <p className="trust-lead">13+ лет практики, высшее образование и членство в Союзе реабилитологов России. Более 1000 клиентов и личный опыт восстановления после тяжёлой травмы.</p>
